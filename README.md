...
|---|---|---|---|---|
| Whole book | Git | Free | [Download](https://git-scm.com/downloads) | Windows, macOS, Linux |
| Whole book | Node.js | Free | [Download](https://nodejs.org/en) | Windows, macOS, Linux |
| Coding | Visual Studio Code | Free | [Download](https://code.visualstudio.com/) | Windows, macOS, Linux |
| React chapters | React 19 | Free | [Download](https://react.dev/learn/start-a-new-react-project) | Windows, macOS, Linux |
| React Native chapters | Xcode (for iOS simulator) | Free | MacOS App Store | macOS |
| React Native chapters | Android Studio (for Android simulator) | Free | [Download](https://developer.android.com/studio) | Windows, macOS, Linux |
| React Native chapters | Expo Go (without simulator) | Free | [Play Store](https://play.google.com/store) or [App Store](https://apps.apple.com/us/app/expo-go/id982107779) | iOS or Android |
...
_Rodrigo Lobenwein_ is a Tech Lead and full stack engineer with hands-on experience in React, TypeScript, .NET, and modern cloud-based architectures. His background in business and management, combined with his expertise in software development, allows him to understand real-world needs and translate them into effective technical solutions. He has worked with international teams, driving technical excellence and quickly becoming a key reference within engineering teams. A technical reviewer for Packt Publishing, he is passionate about understanding the core of problems and finding effective solutions, and enjoys teaching and explaining concepts to different audiences using real-world examples.
